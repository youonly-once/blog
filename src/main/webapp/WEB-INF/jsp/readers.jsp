...
<section class="container container-page">
  ...
  <div class="content">
    ...
    <div class="readers"> <a class="item-readers item-readers-1" target="_blank" href="" rel="nofollow">
      ...
      <img class="avatar" height="36" width="36" src="${pageContext.request.contextPath}/images/icon/icon.png" alt=""><strong>舒新胜</strong>http://www.shuxinsheng.com/</a> <a class="item-readers item-readers-2" target="_blank" href="" rel="nofollow">
      <h4>【银牌读者】<small>评论：12</small></h4>
      <img class="avatar" height="36" width="36" src="${pageContext.request.contextPath}/images/icon/icon.png" alt=""><strong>舒新胜</strong>http://www.shuxinsheng.com/</a> <a class="item-readers item-readers-3" target="_blank" href="" rel="nofollow">
      <h4>【铜牌读者】<small>评论：8</small></h4>
      <img class="avatar" height="36" width="36" src="${pageContext.request.contextPath}/images/icon/icon.png" alt=""><strong>舒新胜</strong>http://www.shuxinsheng.com/</a> <a class="item-readers item-readers-4" target="_blank" href="" rel="nofollow">
